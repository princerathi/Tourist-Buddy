<div class="fotter">	
	 <div class="container">
		 <div class="fotter-grids">
			 ...
			 <p style="text-align:justify">I am PRINCE RATHI, your tour director for your next tour. This blog is for me, but sharing it with you, it is also for you, so you can find useful information for your next tour. This is my wish. </p>
			 </div>
			 <div class="col-md-4 fotter-middle">
				 <h3>Questions About Tourist Buddy?</h3>
				 <div class="footer-list">
						<ul>
                        <li style="text-align:justify"><a href="#"><span></span>
Our Customer Service Department is always happy to answer any questions you might have. Please visit our Contact Page to contact us or call us at +918057529753.</a></li></ul> </div>
						<h3>why Tourist Buddy?</h3>
                        <div class="footer-list">
                        <ul>
...
<p style="padding-right:100px">Designed by: P3 TECH</p>
